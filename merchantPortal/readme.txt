...
and able to be built from/as templates - all arrangement, flow, design, fields, capabilities, and overall concept are entirely human.  The best likeness of AI is a "B- employee" - it will get you half way there, but can only work on really small tasks and lacks vision of the greater whole of the project (or incorrectly interprets it)

I have learned a LOT in this class about web development and implementation, such that I am going to be launching my own web app for a tabletop game alongside a unity game to use the web app forms/database because of how much I learned in this class.  I would HIGHLY encourage the use of AI in these classes as students' ability to create amazing software and applications in this environment is a skill that is really important going forward.  All content in the workplace is done with AI assistance now; there's no reason to teach students to not use those services to create, provided they understand how generative AI and copyright laws work
